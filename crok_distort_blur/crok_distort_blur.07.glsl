...
float fxaaQualityEdgeThresholdMin = 0.0;
...
void main() {
  ...
  vec4 col = vec4(0.0);
  vec4 orig = texture2D(adsk_results_pass6, coords);
  vec4 aa = FxaaPixelShader(coords, vec4(0.0), adsk_results_pass6, adsk_results_pass6, adsk_results_pass6,
