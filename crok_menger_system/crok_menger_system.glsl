...
uniform float MinimumDistance; //	0.0009
uniform float normalDistance;  //	0.0002

uniform int Iterations; //	7
uniform float Scale; //	3.0
uniform float FieldOfView; //	 1.0
uniform float FudgeFactor; //	0.7
uniform float NonLinearPerspective; //	2.0
uniform bool DebugNonlinearPerspective; //	false

uniform float Ambient; //	0.32184
uniform float Diffuse; //	0.5
uniform vec3 LightColor; //	vec3(1.0,1.0,0.858824)
uniform vec3 LightColor2; //	vec3(0.0,0.333333,1.0)
