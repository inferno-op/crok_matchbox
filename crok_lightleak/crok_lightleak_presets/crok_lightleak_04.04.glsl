...
float time = adsk_time *.0025 * f_speed + f_offset;
vec2 resolution = vec2(adsk_result_w, adsk_result_h);


uniform float zoom, amplitude, noise, warp, speed_x, speed_y, brightness, contrast, gain;
...
void main() {
    ...
    gl_FragColor = vec4(color * f_tint,color);
}
