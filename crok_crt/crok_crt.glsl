...
//  -8.0 = soft
// -16.0 = medium
uniform float hardScan; // -12.0

// Hardness of pixels in scanline.
// -2.0 = soft
// -4.0 = hard
uniform float hardPix; // -10.0
...
//  0.0     = no bloom
uniform float bloomAmount; // 1.0/16.0

// Amount of shadow mask.
uniform float maskDark; // 0.8
uniform float maskLight; // 1.2

// Display warp.
// 0.0 = none
// 1.0/8.0 = extreme
uniform vec2 warp; //vec2(1.0/8.0,1.0/8.0); 
...
vec3 Fetch(vec2 pos,vec2 off){
  ...
  return ToLinear(texture2D(source,pos.xy,-16.0).rgb);}
