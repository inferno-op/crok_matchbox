// based on https://www.shadertoy.com/view/XtsSWs by otaviogood
...
vec3 RayTrace(in vec2 fragCoord )
{
    ...
    // debugging camera
    float mx=-iMouse.x/resolution.x*PI*2.0;// + localTime * 0.05;
	float my=iMouse.y/resolution.y*3.14*0.5 + PI/2.0;// + sin(localTime * 0.3)*0.8+0.1;//*PI/2.01;
